...
import com.vehicle.common.utils.file.FileUtils;
import com.vehicle.framework.config.VehicleConfig;
import com.vehicle.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = VehicleConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = VehicleConfig.getUploadPath();
            // 上传并返回新文件名称
